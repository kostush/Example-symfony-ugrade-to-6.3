...
class Transaction
{
     ...
     * @return Transaction
     */
    public function setLocator(?string $locator): ?Transaction
    {
     ...
     * @return Transaction
     */
    public function setOriginCode(?string $originCode): ?Transaction
    {
     ...
     * @return Transaction
     */
    public function setDestinationCode(?string $destinationCode): ?Transaction
    {
