...
use App\Entity\UrbiTransactionLog;
use App\Mapping\Urbi\Transaction;
use App\Repository\UrbiTransactionLogRepository;
...
class TransactionProcessor
{
    ...
    /**
     * @var UrbiTransactionLogRepository
     */
    private $repository;
    ...
    {
        $this->repository = $entityManager->getRepository(UrbiTransactionLog::class);
    ...
    public function addSingleLog(Transaction $transaction): ?UrbiTransactionLog
    {
    ...
    public function findTransactionById(string $transactionId): ?UrbiTransactionLog
    {
    ...
    private function importTransaction(Transaction $transaction, bool $travelDateStatus = false): ?UrbiTransactionLog
    {
