...
/**
 * @ORM\Entity(repositoryClass="App\Repository\UrbiTransactionLogRepository")
 * @ORM\Table(name="urbi_transaction_log")
 */
class UrbiTransactionLog
{
